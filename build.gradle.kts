...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders["MAPS_API_KEY"] = properties.getProperty("mapsApiKey", "")
    }
...
dependencies {
    ...
    // Google Maps - Added first to resolve dependencies
    ...
    // DataStore Preferences for persistent flags

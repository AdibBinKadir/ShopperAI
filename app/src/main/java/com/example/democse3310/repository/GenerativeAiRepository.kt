...
class GenerativeAiRepository {
    ...
    suspend fun findSimilarProducts(image: Bitmap): List<Product> {
        ...
        return listOf(
            Product("1", "Vintage Leather Jacket", "A stylish vintage leather jacket.", BigDecimal("120.00"), "https://example.com/jacket.jpg"),
            Product("2", "Classic Blue Jeans", "Comfortable and durable blue jeans.", BigDecimal("60.00"), "https://example.com/jeans.jpg"),
            Product("3", "White Cotton T-Shirt", "A soft and breathable cotton t-shirt.", BigDecimal("25.00"), "https://example.com/tshirt.jpg")
        )
    }
}
